...
from adb import device_capture_screen, device_connect, device_reset_app, device_tap, safe_device_tap
from actions import (
        ...
        while True:
            ...
            if stage == "MAINMENU":
                if detection_group == "POST_GAME":
                    print("🎮 Detected Stage: MAINMENU (กลับมาหน้าล็อบบี้)")
                ...
                if mystery_box_handled:
                    # Leftover loot/confirm screen for the same round — just dismiss.
